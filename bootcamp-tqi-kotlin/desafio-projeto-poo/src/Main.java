...
public class Main {
    public static void main(String[] args) {
        ...
        devCamila.setNome("Davi");
        devCamila.inscreverBootcamp(bootcamp);
        System.out.println("Conteúdos Inscritos Davi:" + devCamila.getConteudosInscritos());
        devCamila.progredir();
        devCamila.progredir();
        System.out.println("-");
        System.out.println("Conteúdos Inscritos Davi:" + devCamila.getConteudosInscritos());
        System.out.println("Conteúdos Concluídos Davi:" + devCamila.getConteudosConcluidos());
